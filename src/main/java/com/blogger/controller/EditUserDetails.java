		...
		try {
			...
			if(resultSet.next()) {
				...
				pr.append("<html>\r\n"
						...
						+ "				</tr>\r\n"
						+ "				<tr>\r\n"
						+ "					<td><input type=\"text\" value="+resultSet.getString(2)+" name=\"username\"\r\n"
						...
						+ "				</tr>\r\n"
						+ "				<tr>\r\n"
						+ "					<td><input type=\"text\" value="+resultSet.getString(3)+" name=\"emailId\"\r\n"
						...
						+ "				</tr>\r\n"
						+ "				<tr>\r\n"
						+ "					<td><input type=\"text\" value="+resultSet.getString(4)+" name=\"age\"\r\n"
